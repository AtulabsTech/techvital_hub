defmodule EdvitalHubWeb.OnboardingLive.UserRegistration.New do
  @moduledoc false

  use EdvitalHubWeb, :live_component

  alias EdvitalHubWeb.OnboardingLive.Shared.NewPasswordInputComponent
