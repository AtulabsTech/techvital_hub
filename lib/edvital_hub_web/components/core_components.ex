defmodule EdvitalHubWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EdvitalHubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EdvitalHubWeb.Gettext, "errors", msg, opts)
    end
  end
