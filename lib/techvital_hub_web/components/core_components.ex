defmodule TechvitalHubWeb.CoreComponents do
  @moduledoc """
      ...
      <div class="mx-auto w-full max-w-screen-2xl">
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            ...
            <a href="/">
              <img src={~p"/images/default.svg"} width="36" />
            </a>
          </div>
          <div>
            <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TechvitalHubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TechvitalHubWeb.Gettext, "errors", msg, opts)
    end
  end
