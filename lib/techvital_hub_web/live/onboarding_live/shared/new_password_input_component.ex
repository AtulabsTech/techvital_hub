defmodule TechvitalHubWeb.OnboardingLive.Shared.NewPasswordInputComponent do
  @moduledoc false

  use TechvitalHubWeb, :html

  alias TechvitalHubWeb.OnboardingLive.Shared.AuthComponents
  alias TechvitalHubWeb.OnboardingLive.Shared.InputComponents
    ...
    password_input_errors =
      ...
      |> Enum.reduce([], fn {_key, {message, _validation}}, acc ->
        case message do
          ...
          "at least 8+ characters" -> [:length | acc]
