defmodule TechvitalHub.CoursesTest do
  ...
  describe "courses" do
    ...
    @invalid_attrs %{description: nil, difficulty_level: nil, duration_hours: nil, is_featured: nil, phase: nil, position: nil, thumbnail_url: nil, title: nil}
    ...
    test "create_course/1 with valid data creates a course" do
      valid_attrs = %{description: "some description", difficulty_level: "some difficulty_level", duration_hours: 42, is_featured: true, phase: "some phase", position: 42, thumbnail_url: "some thumbnail_url", title: "some title"}
