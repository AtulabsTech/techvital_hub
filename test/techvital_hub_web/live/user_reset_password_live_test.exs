defmodule TechvitalHubWeb.UserResetPasswordLiveTest do
    ...
    test "resets password once", %{conn: conn, token: token, user: user} do
      ...
      {:ok, conn} =
        ...
        |> form("#reset_password_form",
          user: %{
            "password" => "NewValidPassword001@!",
            "password_confirmation" => "NewValidPassword001@!"
          }
        )
        |> render_submit()
      ...
      assert Accounts.get_user_by_email_and_password(user.email, "NewValidPassword001@!")
    end
