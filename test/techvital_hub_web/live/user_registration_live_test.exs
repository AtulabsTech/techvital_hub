defmodule TechvitalHubWeb.UserRegistrationLiveTest do
  ...
  describe "Registration page" do
    test "renders registration page", %{conn: conn} do
      ...
      # assert render_component(TechvitalHubWeb.OnboardingLive.UserRegistration.New,
      #          id: "registration_form",
      #          user: %TechvitalHub.Accounts.User{}
      #        ) =~
      #          "Create an account"
